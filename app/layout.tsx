...
export default function Layout({ children }: { children: React.ReactNode; }) {
  ...
  const pageNow = pathname.split('/')[1] || "curated";

  return (
    <html lang="en" className={`${liberationSerif.variable} ${notoSerif.variable}`}>
      <body>
        {!["login", "signup"].includes(pageNow) && (
            ...
            <div className="flex max-w-[1920px] py-6 px-12 justify-between items-center self-stretch">
              <div className="flex items-center gap-12">
                ...
                <ul className="flex items-center gap-8">
                  <li><a href="/curated" className="flex flex-col items-start hover:py-1 hover:border-b hover:border-[#041729]"><p className={`text-base/[26px] not-italic tracking-[-0.4px] hover:font-semibold hover:text-[#041729] transition-all ${pageNow === "curated" ? "text-[#041729] font-semibold" : "text-[#5F5E5E] font-normal"}`}>Curated</p></a></li>
                  <li><a href="/library" className="flex flex-col items-start hover:py-1 hover:border-b hover:border-[#041729]"><p className={`text-base/[26px] not-italic tracking-[-0.4px] hover:font-semibold hover:text-[#041729] transition-all ${pageNow === "library" ? "text-[#041729] font-semibold" : "text-[#5F5E5E] font-normal"}`}>Library</p></a></li>
                  <li><a href="/archives" className="flex flex-col items-start hover:py-1 hover:border-b hover:border-[#041729]"><p className={`text-base/[26px] not-italic tracking-[-0.4px] hover:font-semibold hover:text-[#041729] transition-all ${pageNow === "archives" ? "text-[#041729] font-semibold" : "text-[#5F5E5E] font-normal"}`}>Archives</p></a></li>
                  <li><a href="/notebook" className="flex flex-col items-start hover:py-1 hover:border-b hover:border-[#041729]"><p className={`text-base/[26px] not-italic tracking-[-0.4px] hover:font-semibold hover:text-[#041729] transition-all ${pageNow === "notebook" ? "text-[#041729] font-semibold" : "text-[#5F5E5E] font-normal"}`}>Notebook</p></a></li>
                </ul>
              </div>
        ...
        {!["login", "signup"].includes(pageNow) && (
          <ul className="flex w-full pt-[12px] px-[28px] pb-[24px] items-center gap-6 fixed z-50 left-0 bottom-0 justify-around bg-[rgba(253,249,239,0.90)] rounded-t-lg rounded-r-lg flex-nowrap overflow-x-auto md:hidden">{/*Mobile bottom bar*/}
            ...
            </svg></span></span><span className="flex flex-col items-center"><p className={`text-center text-[11px]/[16.5px] not-italic tracking-[1.1px] uppercase ${pageNow === "curated" ? "text-[#041729] font-semibold" : "text-[#5F5E5E] font-medium"}`}>CURATED</p></span></a></li>
            <li><a href="/library" className={`flex px-2 py-5 flex-col justify-center items-center gap-[-1px] rounded-xl transition-all ${pageNow === "library" ? "bg-[#E6E2D8]" : "opacity-[0.7]"}`}><span className="flex pb-1 flex-col items-start"><span className="flex flex-col items-center"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill={pageNow === "library" ? "#041729" : "#5F5E5E"}>
              <path d="M2 20C1.45 20 0.979167 19.8042 0.5875 19.4125C0.195833 19.0208 0 18.55 0 18V4H2V18H16V20H2ZM6 16C5.45 16 4.97917 15.8042 4.5875 15.4125C4.19583 15.0208 4 14.55 4 14V2C4 1.45 4.19583 0.979167 4.5875 0.5875C4.97917 0.195833 5.45 0 6 0H18C18.55 0 19.0208 0.195833 19.4125 0.5875C19.8042 0.979167 20 1.45 20 2V14C20 14.55 19.8042 15.0208 19.4125 15.4125C19.0208 15.8042 18.55 16 18 16H6ZM11 9L13.5 7.5L16 9V2H11V9Z" fill={pageNow === "library" ? "#041729" : "#5F5E5E"} />
            </svg></span></span><span className="flex flex-col items-center"><p className={`text-center text-[11px]/[16.5px] not-italic tracking-[1.1px] uppercase ${pageNow === "library" ? "text-[#041729] font-semibold" : "text-[#5F5E5E] font-medium"}`}>Library</p></span></a></li>
            <li><a href="/search" className={`flex px-2 py-5 flex-col justify-center items-center gap-[-1px] rounded-xl transition-all ${pageNow === "search" ? "bg-[#E6E2D8]" : "opacity-[0.7]"}`}><span className="flex pb-1 flex-col items-start"><span className="flex flex-col items-center"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill={pageNow === "search" ? "#041729" : "#5F5E5E"}>
              <path d="M16.6 18L10.3 11.7C9.8 12.1 9.225 12.4167 8.575 12.65C7.925 12.8833 7.23333 13 6.5 13C4.68333 13 3.14583 12.3708 1.8875 11.1125C0.629167 9.85417 0 8.31667 0 6.5C0 4.68333 0.629167 3.14583 1.8875 1.8875C3.14583 0.629167 4.68333 0 6.5 0C8.31667 0 9.85417 0.629167 11.1125 1.8875C12.3708 3.14583 13 4.68333 13 6.5C13 7.23333 12.8833 7.925 12.65 8.575C12.4167 9.225 12.1 9.8 11.7 10.3L18 16.6L16.6 18ZM6.5 11C7.75 11 8.8125 10.5625 9.6875 9.6875C10.5625 8.8125 11 7.75 11 6.5C11 5.25 10.5625 4.1875 9.6875 3.3125C8.8125 2.4375 7.75 2 6.5 2C5.25 2 4.1875 2.4375 3.3125 3.3125C2.4375 4.1875 2 5.25 2 6.5C2 7.75 2.4375 8.8125 3.3125 9.6875C4.1875 10.5625 5.25 11 6.5 11Z" fill={pageNow === "search" ? "#041729" : "#5F5E5E"} />
            </svg></span></span><span className="flex flex-col items-center"><p className={`text-center text-[11px]/[16.5px] not-italic tracking-[1.1px] uppercase ${pageNow === "search" ? "text-[#041729] font-semibold" : "text-[#5F5E5E] font-medium"}`}>SEARCH</p></span></a></li>
            <li><a href="/profile" className={`flex px-2 py-5 flex-col justify-center items-center gap-[-1px] rounded-xl transition-all ${pageNow === "profile" ? "bg-[#E6E2D8]" : "opacity-[0.7]"}`}><span className="flex pb-1 flex-col items-start"><span className="flex flex-col items-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill={pageNow === "profile" ? "#041729" : "none"}>
              <path d="M8 8C6.9 8 5.95833 7.60833 5.175 6.825C4.39167 6.04167 4 5.1 4 4C4 2.9 4.39167 1.95833 5.175 1.175C5.95833 0.391667 6.9 0 8 0C9.1 0 10.0417 0.391667 10.825 1.175C11.6083 1.95833 12 2.9 12 4C12 5.1 11.6083 6.04167 10.825 6.825C10.0417 7.60833 9.1 8 8 8ZM0 16V13.2C0 12.6333 0.145833 12.1125 0.4375 11.6375C0.729167 11.1625 1.11667 10.8 1.6 10.55C2.63333 10.0333 3.68333 9.64583 4.75 9.3875C5.81667 9.12917 6.9 9 8 9C9.1 9 10.1833 9.12917 11.25 9.3875C12.3167 9.64583 13.3667 10.0333 14.4 10.55C14.8833 10.8 15.2708 11.1625 15.5625 11.6375C15.8542 12.1125 16 12.6333 16 13.2V16H0ZM2 14H14V13.2C14 13.0167 13.9542 12.85 13.8625 12.7C13.7708 12.55 13.65 12.4333 13.5 12.35C12.6 11.9 11.6917 11.5625 10.775 11.3375C9.85833 11.1125 8.93333 11 8 11C7.06667 11 6.14167 11.1125 5.225 11.3375C4.30833 11.5625 3.4 11.9 2.5 12.35C2.35 12.4333 2.22917 12.55 2.1375 12.7C2.04583 12.85 2 13.0167 2 13.2V14ZM8 6C8.55 6 9.02083 5.80417 9.4125 5.4125C9.80417 5.02083 10 4.55 10 4C10 3.45 9.80417 2.97917 9.4125 2.5875C9.02083 2.19583 8.55 2 8 2C7.45 2 6.97917 2.19583 6.5875 2.5875C6.19583 2.97917 6 3.45 6 4C6 4.55 6.19583 5.02083 6.5875 5.4125C6.97917 5.80417 7.45 6 8 6Z" fill={pageNow === "profile" ? "#041729" : "#5F5E5E"} />
