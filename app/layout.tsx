  ...
  return (
    <html lang="en" className={`${liberationSerif.variable} ${notoSerif.variable}`}>
      <body>
        ...
        <div id="TopDesktopBar" className="hidden md:flex w-full flex-col items-start bg-[#FDF9EF]">{/*Desktop Top Nav Bar*/}
          <div className="flex max-w-[1920px] py-6 px-12 justify-between items-center self-stretch">
            <div className="flex items-center gap-12">
              <a className="flex flex-col items-start"><p className="font-liberation text-[#041729] text-2xl/[32px] italic font-normal">The Private Library</p></a>
        ...
        <div className="hidden md:flex w-full flex-col items-start bg-[#F7F3E9]">{/*Desktop bottom bar*/}
          <div className="flex max-w-[1920px] py-16 px-12 justify-between items-center self-stretch">
            ...
            <ul className="flex justify-center items-start gap-12">
              <li className="flex flex-col items-start self-stretch"><a><p className="text-[#5F5E5E] text-[12px]/[16px] not-italic font-normal tracking-[0.8px] uppercase">THE CURATOR'S NOTE</p></a></li>
              <li className="flex flex-col items-start self-stretch"><a><p className="text-[#5F5E5E] text-[12px]/[16px] not-italic font-normal tracking-[0.8px] uppercase">PRIVACY</p></a></li>
              <li className="flex flex-col items-start self-stretch"><a><p className="text-[#5F5E5E] text-[12px]/[16px] not-italic font-normal tracking-[0.8px] uppercase">TERMS OF SERVICE</p></a></li>
              <li className="flex flex-col items-start self-stretch"><a><p className="text-[#5F5E5E] text-[12px]/[16px] not-italic font-normal tracking-[0.8px] uppercase">COLOPHON</p></a></li>
            </ul>
